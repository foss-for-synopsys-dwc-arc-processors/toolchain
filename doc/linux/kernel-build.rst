...
sources::
    ...
    $ mkdir arc-2021.03-linux-guide
    $ cd arc-2021.03-linux-guide
...
any name. For example it can be ``arc-2021.03-linux-guide/hs_defconfig``.
...
``arc-2021.03-linux-guide/output/images/vmlinux``.
