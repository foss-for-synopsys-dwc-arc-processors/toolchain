...
define create_tar
	$(TAR) czf $O/$1$(TAR_EXT) -C $O \
		--owner=0 --group=0 --numeric-owner $1/
endef
...
define create_windows_tar
	$(TAR) czf $O/$1$(TAR_EXT) -C $O \
		--owner=0 --group=0 --numeric-owner --hard-dereference $1/
endef
...
DEPLOY_BUILD_ARTIFACTS = $(DEPLOY_BUILD_ARTIFACTS-y)

DEPLOY_BUILD_ARTIFACTS-$(ENABLE_ELF_TOOLS) += $(TOOLS_ELFLE_HOST_DIR)
ifeq ($(ENABLE_ELF_TOOLS),y)
...
$O/.stamp_ide_linux_tar: \
	...
	$(call create_tar,$(IDE_LINUX_INSTALL))
	touch $@
...
$O/.stamp_ide_macos_tar: \
	...
	$(call create_tar,$(IDE_MACOS_INSTALL))
	touch $@
