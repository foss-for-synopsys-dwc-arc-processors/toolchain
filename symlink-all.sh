...
# A wrapper for the symlink-dirs script, to build a symlink tree of all
...
# The <unisrc> directory is assumed to exist. symlink-dirs is run in that
...
# symlink-dirs script can be found in ${ARC_GNU}/toolchain
...
for component in $*
do
    if ! ${ARC_GNU}/toolchain/symlink-dirs.sh ${ARC_GNU}/${component}
    then
	exit 1
    fi
done
